    ...
    <div className="flex flex-col justify-center h-screen items-center">
      ...
      <header className="flex w-full p-5 justify-between text-sm text-gray-700">
        ...
        <div className="flex space-x-4 items-center">
          ...
          <ViewGridIcon className="h-10 w-10 p-2 rounded-full hover:bh-gray-100 cursor-pointer" />
          <Avatar url="https://i.pinimg.com/280x280_RS/f4/19/8e/f4198efb5525ce5c44e3fc480ecafb83.jpg" />
        </div>
      </header>
